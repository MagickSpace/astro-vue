...
export const collections = { projects: projectsCollection, financialInfos: financialInfosCollection, blog: blogCollection, work, statistic, promotions: promotionsCollection, comments, authors, legal, releases, services: servicesCollection, tags: tagsCollection, category: categoryCollection };
